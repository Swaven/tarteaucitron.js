...
tarteaucitron.lang = {
    ...
    "alertBigPrivacy": "私たちのパートナーは、Cookieを使用してトラフィックを最適化したいと考えています。",
    ...
    "mandatoryText": "Swavenは、買い物客が商品を見つけてお気に入りの小売店にリダイレクトするのを支援するサービスを提供します。 Swavenは、ブラウザにトレーサーやCookieを保存しません。"
};
